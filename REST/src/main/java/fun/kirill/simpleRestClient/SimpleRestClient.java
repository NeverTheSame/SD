package fun.kirill.simpleRestClient;
...
public class SimpleRestClient {
   ...
   /**
    * Initiates a new request to the specified CustomURL
    * @param url
    *  a string representing an CustomURL. If the url String is not valid, an exception is thrown
    * @return
   ...
   public static class Response {
       ...
       * In order to parse the data, an {@link EntityReader} must be provided via {@link ServiceLoader}
